...
//        try {
//            privateKey = keyGen.getPrivateKeyformBytes(ReadKeyFormFile.readKeyFromFile("src/main/java/hcmuaf/edu/vn/BikeEcommerce/atbm/privateInfo/GreenLockPrivateKey.key"));
//        } catch (IOException e) {
