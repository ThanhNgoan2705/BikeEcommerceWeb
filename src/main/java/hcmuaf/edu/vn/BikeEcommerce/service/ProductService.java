...
public class ProductService {
    ...
    public List<Product> getProductByFilter(String categoryId, String brandId, String supplierId, String discountId, String status, int minPrice, int maxPrice, String wheelSize) {
