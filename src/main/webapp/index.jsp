	...
	<div class="top-header-content">
		<header class="tophny-header">
			<div class="container-fluid">
				<div class="top-right-strip row">
					...
					<!--//right-->
					<div class="overlay-login text-left" style="display: block;width: 30%">
							...
							<div class="login-bghny p-md-5 p-4 mx-auto mw-100">
								...
								<form action="#" method="post">
									...
									<div class="form-group">
										...
										<input type="password" class="form-control" userId="exampleInputPassword1"
									...
									<button type="button" class="submit-login btn mb-4 text-primary"><a href="signUp.html" style="color: white">Sign Up</a></button>
								</form>
								<!--//login-form-->
							</div>
							<!---->
						...
						<div userId="search" class="pop-overlay">
							<div class="popup">
								...
								<form action="#" method="post" class="search-box">
									<input type="search" placeholder="Keyword" userName="search" required="required"
										autofocus="">
		...
		<div class="bannerhny-content">
			...
			<div class="content-baner-inf">
				<div userId="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
				...
				<div class="video-gd-right col-lg-8">
					<div class="video-inner text-center">
								<!--popup-->
									...
									<div userId="small-dialog" class="mfp-hide">
				...
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2 transmitv">
						<div class="product-image2">
							...
							<form action="#" method="post">
									<input type="hidden" userName="cmd" value="_cart">
									<input type="hidden" userName="add" value="1">
									<input type="hidden" userName="transmitv_item" value="Women Maroon Top">
									<input type="hidden" userName="amount" value="899.99">
						...
						<div class="product-image2">
							...
							<div class="transmitv single-item">
									<form action="#" method="post">
											<input type="hidden" userName="cmd" value="_cart">
											<input type="hidden" userName="add" value="1">
											<input type="hidden" userName="transmitv_item" value="Men's Pink Shirt">
											<input type="hidden" userName="amount" value="599.99">
											<button type="submit" class="transmitv-cart ptransmitv-cart add-to-cart">
												Add to Cart
											</button>
										</form>
						...
						<div class="product-image2">
							...
							<div class="transmitv single-item">
									<form action="#" method="post">
											<input type="hidden" userName="cmd" value="_cart">
											<input type="hidden" userName="add" value="1">
											<input type="hidden" userName="transmitv_item" value="Dark Blue Top">
											<input type="hidden" userName="amount" value="799.99">
											<button type="submit" class="transmitv-cart ptransmitv-cart add-to-cart">
												Add to Cart
											</button>
										</form>
						...
						<div class="product-image2">
							...
							<div class="transmitv single-item">
									<form action="#" method="post">
											<input type="hidden" userName="cmd" value="_cart">
											<input type="hidden" userName="add" value="1">
											<input type="hidden" userName="transmitv_item" value="Women Tunic">
											<input type="hidden" userName="amount" value="399.99">
											<button type="submit" class="transmitv-cart ptransmitv-cart add-to-cart">
												Add to Cart
											</button>
										</form>
						...
						<div class="product-image2">
							...
							<div class="transmitv single-item">
									<form action="#" method="post">
											<input type="hidden" userName="cmd" value="_cart">
											<input type="hidden" userName="add" value="1">
											<input type="hidden" userName="transmitv_item" value="Yellow T-Shirt">
											<input type="hidden" userName="amount" value="299.99">
											<button type="submit" class="transmitv-cart ptransmitv-cart add-to-cart">
												Add to Cart
											</button>
										</form>
						...
						<div class="product-image2">
							...
							<div class="transmitv single-item">
									<form action="#" method="post">
											<input type="hidden" userName="cmd" value="_cart">
											<input type="hidden" userName="add" value="1">
											<input type="hidden" userName="transmitv_item" value="Straight Kurta">
											<input type="hidden" userName="amount" value="699.99">
											<button type="submit" class="transmitv-cart ptransmitv-cart add-to-cart">
												Add to Cart
											</button>
										</form>
						...
						<div class="product-image2">
							...
							<div class="transmitv single-item">
									<form action="#" method="post">
											<input type="hidden" userName="cmd" value="_cart">
											<input type="hidden" userName="add" value="1">
											<input type="hidden" userName="transmitv_item" value="White T-Shirt">
											<input type="hidden" userName="amount" value="599.99">
											<button type="submit" class="transmitv-cart ptransmitv-cart add-to-cart">
												Add to Cart
											</button>
						...
						<div class="product-image2">
							...
							<div class="transmitv single-item">
									<form action="#" method="post">
											<input type="hidden" userName="cmd" value="_cart">
											<input type="hidden" userName="add" value="1">
											<input type="hidden" userName="transmitv_item" value="Blue Sweater">
											<input type="hidden" userName="amount" value="499.99">
											<button type="submit" class="transmitv-cart ptransmitv-cart add-to-cart">
												Add to Cart
											</button>
										</form>
	...
	<div class="post-6-mian py-5">
		<div class="container py-lg-5">
			...
			<div class="post-hny-grids row mt-5">
				<div class="col-lg-3 col-md-6 grids5-info column-img" userId="zoomIn">
					<a href="#">
						<figure>
	...
	<div class="customers-sec-6-cintent py-5">
		...
		<div class="container py-lg-5">
			...
			<div class="row customerhny my-lg-5 my-4">
				<div class="col-md-12">
					<div userId="customerhnyCarousel" class="carousel slide" data-ride="carousel">
						...
						<form action="#" method="post" class="signin-form mt-lg-5 mt-4">
							<div class="forms-gds">
								<div class="form-input">
									<input type="email" userName="" placeholder="Your email here" required="">
								</div>
