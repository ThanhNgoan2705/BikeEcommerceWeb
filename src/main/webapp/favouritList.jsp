    ...
    <div class="row ">
        <div class="col-3 mb-3">
            <div class="list-group list-group-light">
                ...
                <a class="list-group-item list-group-item-action  px-3 border-0" id="user-information"
                ...
                <a class="list-group-item list-group-item-action active px-3 border-0" id="favorite-list"
        ...
        <div class="col-6">
            <div id="nav-tabContent">
                <div id="listFavourite">
                    <!-- Container for demo purpose -->
                    <div class="container my-5">

                        <!--Section: Design Block-->
                        <section class="mb-10">
                            <h5 class="mb-4">Women's perfumes</h5>
                            <div class="row">
                                <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
                                    ...
                                    <div class="bg-image hover-zoom shadow-4 rounded-5 mb-3">
                                        ...
                                        <a
                                                href="#!"
                                                role="button"
                                                class="btn btn-danger btn-floating position-absolute"
                                                style="z-index: 10; left: 0.5rem; bottom: 0.5rem"
                                        >
                                            <i class="fas fa-heart"></i>
                                        </a>
                                        <img src="https://mdbootstrap.com/img/Photos/new-design-blocks/ecommerce/checkout/11.jpg" alt="Parfum 1"
                                             class="w-100">
                                        <a href="#!">
                                            <div class="mask">
                                    ...
                                    <p class="mb-1">
                                        <strong><a href="#!" class="text-reset">D&G 3 L'impératice</a></strong>
                                    </p>
                                    <p class="mb-0">€99,00 / 35 ml</p>
                                </div>
                                <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
                                    <div class="bg-image hover-zoom shadow-4 rounded-5 mb-3">
                                        <!-- Wishlist button -->
                                        ...
                                        <img src="https://mdbootstrap.com/img/Photos/new-design-blocks/ecommerce/checkout/12.jpg" alt="Parfum 1"
                                             class="w-100">
                                        <a href="#!">
                                            <div class="mask"></div>
                                        </a>
                                    ...
                                    <p class="mb-1">
                                        <strong><a href="#!" class="text-reset">Nécessaire The Deodorant</a></strong>
                                    </p>
                                    <p class="mb-0">€39,00 / 50 ml</p>
                                </div>
                                <div class="col-md-6 col-lg-3 mb-4 mb-md-0">
                                    <div class="bg-image hover-zoom shadow-4 rounded-5 mb-3">
                                        ...
                                        <img src="https://mdbootstrap.com/img/Photos/new-design-blocks/ecommerce/checkout/13.jpg" alt="Parfum 1"
                                             class="w-100">
                                        <a href="#!">
                                            <div class="mask"></div>
                                        </a>
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <div class="bg-image hover-zoom shadow-4 rounded-5 mb-3">
                                        ...
                                        <img src="https://mdbootstrap.com/img/Photos/new-design-blocks/ecommerce/checkout/14.jpg" alt="Parfum 1"
                                             class="w-100">
                                        <a href="#!">
                                            <div class="mask"></div>
                                        </a>
                                    ...
                                    <p class="mb-1">
                                        <strong><a href="#!" class="text-reset">CHANEL N°5</a></strong>
                                    </p>
                                    <p class="mb-0">€109,00 / 35 ml</p>
                                </div>
                            </div>
                        </section>
                        <!--Section: Design Block-->
