...
<header>
    ...
    <nav id="main-sidenav" class="sidenav sidenav-sm shadow-1" data-mdb-hidden="false" data-mdb-accordion="true">
        ...
        <ul class="sidenav-menu px-2 pb-5">
            ...
            <li class="sidenav-item">
                <a class="sidenav-link" href="category.html">
                        ...
                        <div class="col-lg-6 mb-4 mb-lg-0 text-center text-lg-start">
                            ...
                            <nav class="d-flex justify-content-center justify-content-lg-start">
                                <h6 class="mb-0">
                                    ...
                                    <span>/</span>
                                    <a href="category.html" class="text-muted"><u>Category</u></a>
                                </h6>
                            </nav>
                            <!-- Breadcrumb -->
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table text-nowrap table-borderless table-striped table-hover align-middle mb-0 bg-white">
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <p class="text-muted mb-0">Category parent Name</p>
                                        </div>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="fw-normal mb-1 text-danger">non-active</p>
                                </td>
                                <td class="align-content-center">
                                    <!-- Button trigger modal -->
                                    <button type="button" class="btn" data-mdb-toggle="modal"
                ...
                <div class="container py-5 h-100">
                    <form class="row g-3 needs-validation" novalidate>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="addNameCategory" value="Mark" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="addLevel" required>
