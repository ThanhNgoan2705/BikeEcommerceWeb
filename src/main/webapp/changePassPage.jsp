    ...
    <div class="row ">
        <div class="col-3 mb-3">
            <div class="list-group list-group-light">
                ...
                <a class="list-group-item list-group-item-action active px-3 border-0" id="list-messages-list"
            ...
            <div id="changePass">
                <form>
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" id="currentPass" aria-describedby="currentPass">
                        <div id="oldPass" class="form-text">Please enter your current password</div>
                    </div>
                    <div class="mb-3">
                        <label for="newPass" class="form-label">New Password</label>
                        <input type="password" class="form-control" id="newPass" aria-describedby="newPass">
                        <div id="newPassword" class="form-text">Please enter your new password</div>
                    </div>
                    <div class="mb-3">
                        <label for="repeatPass" class="form-label">Repeat New Password</label>
                        <input type="password" class="form-control" id="repeatPass" aria-describedby="repeatPass">
                        <div id="repeatNewPass" class="form-text">Please repeat your new password</div>
                    </div>
                </form>
