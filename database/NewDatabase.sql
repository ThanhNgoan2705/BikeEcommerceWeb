...
INSERT INTO `category` (`category_id`, `name`, `description`, `image`, `created_at`, `updated_at`, `parent_id`, `active`, `level`, `short_id`) VALUES
                                                                                                                                                   ('1', 'Electronics', 'Electronics Category', NULL, '2023-11-21 23:49:49', '2023-11-21 23:49:49', NULL, 1, 1, 'ELEC'),
...
INSERT INTO `image_product` (`image_product_id`, `link`, `product_id`, `color_id`, `created_at`, `updated_at`) VALUES
                                                                                                                   ('1', 'image1.jpg', '1', NULL, '2023-11-21 23:51:11', '2023-11-23 03:51:11'),
                                                                                                                   ('2', 'image2.jpg', '1', NULL, '2023-11-21 23:51:11', '2023-11-23 03:51:11'),
                                                                                                                   ('3', 'image3.jpg', '2', NULL, '2023-11-21 23:51:11', '2023-11-23 03:51:11'),
                                                                                                                   ('4', 'image4.jpg', '3', NULL, '2023-11-21 23:51:11', '2023-11-23 03:51:11'),
                                                                                                                   ('5', 'image5.jpg', '4', NULL, '2023-11-21 23:51:11', '2023-11-23 03:51:11');
...
INSERT INTO `order` (`order_id`, `user_id`, `full_address`, `price`, `discount`, `shipping_fee`, `total`, `send_day`, `receive_day`, `status`, `created_at`, `updated_at`) VALUES
                                                                                                                                                                               ...
                                                                                                                                                                               ('231211208d6f', '94face32-ca88-4729-b3de-b34a0e390e48', 'tran phu, tay do, hung ha', 179998, 0, 100000, 279998, NULL, NULL, 0, '2023-12-10 14:56:32', '2023-12-10 14:56:32'),
                                                                                                                                                                               ('2312116ad5a5', '94face32-ca88-4729-b3de-b34a0e390e48', 'tran phu, tay do, hung ha', 179998, 0, 100000, 279998, NULL, NULL, 0, '2023-12-10 14:33:18', '2023-12-10 14:33:18'),
                                                                                                                                                                               ('231211cb6626', '94face32-ca88-4729-b3de-b34a0e390e48', 'tran phu, tay do, hung ha', 179998, 0, 100000, 279998, NULL, NULL, 0, '2023-12-10 14:57:31', '2023-12-10 14:57:31'),
...
INSERT INTO `user` (`user_id`, `email`, `salt`, `pass`, `user_name`, `created_at`, `updated_at`, `role`) VALUES
                                                                                                             ('94face32-ca88-4729-b3de-b34a0e390e48', 'admin@gmail.com', '8a316e582ae2898b941eb2f82d3ef209', 'f72633c729b73b342cfb5da6910fa7800599d0a52ab211e11bc575f328fc5cff', 'hai', '2023-11-21 23:52:14', '2023-11-21 23:52:32', 1),
...
ALTER TABLE `image_product`
    ...
    ADD KEY `image_product_color_color_id_fk` (`color_id`);
...
--
ALTER TABLE `image_product`
    ADD CONSTRAINT `image_product_color_color_id_fk` FOREIGN KEY (`color_id`) REFERENCES `color` (`color_id`),
